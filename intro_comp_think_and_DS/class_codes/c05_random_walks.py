...
# Set seed pseudo-random number generator
random.seed(0)

def main():
    # ----------------------------------------
    # Simulate random walks with 'UsualDrunk'
    # ----------------------------------------
    # Sanity check
    ...
    # ----------------------------------------
    # Compare 'UsualDrunk' with 'MasochistDrunk'
    # ----------------------------------------
...
# A class useful for plotting (iterate through plotting styles)
